            ...
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
                ...
                {isAdmin && (
                    <>
                        ...
                        <Link to="/activity-logs" className={cardClass}>
                            <div className={iconClass}>
                            ...
                            <div className="min-w-0">
                                <p className="text-sm font-medium text-stone-500">Logs de Atividade</p>
                                <p className="text-lg font-semibold text-stone-800">Ver histórico</p>
                            </div>
                        </Link>
                    </>
                )}
